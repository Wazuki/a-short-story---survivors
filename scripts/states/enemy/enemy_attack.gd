...
func enter(_previous_state_path: String = "", _data := {}) -> void:
	...
	enemy.animation_player.play(anim_prefix + ATTACK)
...
func attack() -> void:
	...
	if enemy.animation_player.animation == anim_prefix + ATTACK: # Safety check to make sure we're attacking.
